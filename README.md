...
│   ├── stats.html          # Инфо о размерах chunks
...
| `gen-docs` | Генерирует документацию проекта в папке `./docs`.                |
| `upgrade`  | Обновляет все npm пакеты в проекте.                              |
...
1. **Клонируйте репозиторий**:
   ...
   ```bash
   git clone git@github.com:rubyhat/panaceata-client.git
   cd panaceata-client
   ```
